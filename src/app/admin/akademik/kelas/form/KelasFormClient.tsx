    ...
    return (
        <div className="max-w-2xl">
            ...
            <p className="mb-4 text-sm">
                <Link href="/admin/akademik/kelas" className="text-ink-muted underline underline-offset-4">
            ...
            <form action={formAction} className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href="/admin/akademik/kelas" className="text-sm text-ink-muted underline underline-offset-4">
                        Batal
                    </Link>
                </div>
            </form>
