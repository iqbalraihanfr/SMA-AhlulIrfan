<section>
    <header>
        <h2 class="text-lg font-medium text-ink">Informasi Akun</h2>
        <p class="mt-1 text-sm text-ink-muted">Perbarui nama dan alamat email akun Anda.</p>
    </header>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'name','value' => 'Nama']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'name','value' => 'Nama']); ?>
...
<?php /**PATH /Users/iqbalrei/Projects/KKN/SMA-AhlulIrfan/resources/views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>